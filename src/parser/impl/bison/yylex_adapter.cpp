...
static int mapToken(const Token& t) {
    switch (t.type) {
        ...
        case TokenType::Ident:      return TOK_IDENT;

        case TokenType::KW_MODULE:  return TOK_KW_MODULE;
        case TokenType::KW_BEGIN:   return TOK_KW_BEGIN;
        case TokenType::KW_END:     return TOK_KW_END;
